...
draw_speech = function()
    ...
    if (worm.speech) then 
        -- Draw speech bubble
        spr(gsprites.speech_corner,8*ul.x,8*ul.y)
        spr(gsprites.speech_corner,8*br.x,8*ul.y,1,1,true,false)
        spr(gsprites.speech_corner,8*ul.x,8*br.y,1,1,false,true)
        spr(gsprites.speech_corner,8*br.x,8*br.y,1,1,true,true)
        for i=ul.x+1,br.x-1 do 
            spr(gsprites.speech_edge_top,8*i,8*ul.y)
            spr(gsprites.speech_edge_top,8*i,8*br.y,1,1,false,true)
        end
        for j=ul.y+1,br.y-1 do 
            spr(gsprites.speech_edge_side,8*ul.x,8*j,1,1,true)
            spr(gsprites.speech_edge_side,8*br.x,8*j)
        end
        rectfill(8*ul.x+8,8*ul.y+8,8*br.x,8*br.y,7)
    end
end
...
intro_check = function()
    if (gstate == "intro") then 
        ...
        -- level
        if ((bnp('z') or bnp('x')) or intro_timer > 300) then
            gstate = "move"
            glevel = 1
            --glevel = 1
            play_bridge() -- for now
...

...

__gff__
